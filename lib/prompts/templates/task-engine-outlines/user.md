...
If the request is not suitable, generate a normal Gyaan-style outline using slide plus ordinary interactive widgets only. Do not output `procedural-skill` for non-vocational topics.
