...
export interface GeneratedSlideContent {
  ...
  remark?: string;
  /**
   * [A] MERGE: when grid-DSL generates slide content + teacher actions in a
   * single LLM call, the actions ride along here so generateSceneActions can
   * reuse them and skip its second call.
   */
  actions?: unknown[];
}
