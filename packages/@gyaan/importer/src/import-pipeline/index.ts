/**
 * High-level entry: parsed pptxtojson(-pro) JSON → Gyaan canvas `Slide[]`.
 *
 ...
 * whole import either.
 */
import type { Slide } from '@gyaan/dsl';
...
/**
 * Convert a pre-parsed pptxtojson(-pro) `Output` JSON into Gyaan slides.
 *
...
/**
 * Parse a .pptx file and convert it into Gyaan canvas slides.
 *
