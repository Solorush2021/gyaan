/**
 * The GYAAN slide object model — the canonical, dependency-free contract.
 *
 * This file is the single source of truth that supersedes the three copies that
 * had drifted apart before @gyaan/dsl existed:
 *   - app:      lib/types/slides.ts
 *   - renderer: packages/@gyaan/renderer/src/types/slides.ts
 *   - importer: packages/@gyaan/importer/src/gyaan/types/slides.ts
 *
