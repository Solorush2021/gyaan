...
export function GenerationToolbar({
  ...
  const pillActive = `${pillCls} border-primary/20 dark:border-primary/30 bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary-foreground font-semibold shadow-sm`;
    ...
    <div className="flex items-center gap-1 flex-wrap">
      ...
      <div className="flex min-w-0 items-center gap-1">
        ...
        <Popover>
          <PopoverTrigger asChild>
            {pdfFile ? (
              <button className={pillActive}>
                ...
                <span
                  role="button"
                  className="size-4 rounded-full inline-flex items-center justify-center hover:bg-primary/20 dark:hover:bg-primary/30 transition-colors"
                  onClick={(e) => {
                    e.stopPropagation();
          ...
          <PopoverContent align="start" className={cn("w-72 p-0", designTokens.layouts.glassCard.base)}>
            {/* Parser selector */}
        ...
        {webSearchAvailable ? (
          <Popover>
            ...
            <PopoverContent align="start" className={cn("w-64 p-3 space-y-3", designTokens.layouts.glassCard.base)}>
              {/* Toggle */}
              <button
                onClick={() => {
...
function InlineThinkingControl({
  ...
  const selectTriggerCls =
    'h-6 min-w-[84px] rounded-full border-0 bg-primary/10 px-2 py-0 !text-[10px] font-medium leading-none text-primary shadow-none focus-visible:ring-0 data-[size=sm]:h-6 dark:bg-primary/20 dark:text-primary-foreground [&_svg]:size-3';
      ...
      <div className="flex min-w-0 items-center gap-0.5 rounded-full border border-primary/20 bg-background/65 p-0.5 dark:border-primary/30 dark:bg-primary/10">
        {hasAutoBudget && (
          ...
          >
            <SelectTrigger
              size="sm"
              className="h-6 min-w-[76px] rounded-full border-0 bg-primary/10 px-2 py-0 !text-[10px] font-medium leading-none text-primary shadow-none focus-visible:ring-0 data-[size=sm]:h-6 dark:bg-primary/20 dark:text-primary-foreground [&_svg]:size-3"
            >
              <SelectValue />
            </SelectTrigger>
  ...
  return (
    ...
    >
          ...
          <PopoverTrigger asChild>
            <button
              ...
              className={cn(
                ...
                'border-primary/20 bg-primary/5 text-primary hover:bg-primary/10 dark:border-primary/30 dark:bg-primary/10 dark:text-primary-foreground',
                currentModelId &&
                  'shadow-[0_0_0_1px_rgba(13,148,136,0.12)] dark:shadow-[0_0_0_1px_rgba(45,212,191,0.16)]',
              )}
            >
              {currentProviderIcon ? (
                <img
              ...
              {currentThinkingLabel && (
                <span className="shrink-0 rounded-full bg-white/80 px-1.5 py-0.5 text-[10px] font-semibold leading-none text-primary ring-1 ring-primary/20 dark:bg-primary/10 dark:text-primary-foreground dark:ring-primary/30">
                  {currentThinkingLabel}
                </span>
              )}
            </button>
      ...
      <PopoverContent
        ...
        sideOffset={8}
        collisionPadding={12}
        className={cn("w-[640px] max-w-[calc(100vw-2rem)] overflow-hidden p-0", designTokens.layouts.glassCard.base)}
      >
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive
                          ? 'bg-background text-foreground shadow-sm ring-1 ring-primary/20 dark:ring-primary/40'
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? 'bg-primary/5 text-primary ring-1 ring-primary/20 dark:bg-primary/10 dark:text-primary-foreground dark:ring-primary/30'
                          : 'hover:bg-muted/60',
                      )}
                    >
                      <div className="min-w-0 flex-1">
