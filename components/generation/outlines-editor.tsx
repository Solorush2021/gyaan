...
> = {
  ...
  quiz: {
    chip: 'bg-purple-50 text-[var(--gyaan-teal-dark)] dark:bg-[var(--gyaan-teal)]/10 dark:text-purple-300',
    chipHover: 'hover:bg-purple-100/80 dark:hover:bg-[var(--gyaan-teal)]/15',
    accent: 'bg-[var(--gyaan-teal)]',
    dot: 'bg-[var(--gyaan-teal-light)]',
  },
  interactive: {
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        designTokens.layouts.glassCard.base,
      )}
    >
      {/* Soft gradient wash */}
      ...
      <div className="relative flex flex-col gap-3 border-t border-border/40 bg-gradient-to-t from-background/95 to-transparent px-6 py-4 md:flex-row md:items-center md:justify-between md:px-10 md:py-5">
        ...
        <div className="flex flex-col-reverse gap-2 md:flex-row md:items-center md:gap-2">
          ...
          <Button
            ...
            className="rounded-full px-6 bg-primary text-primary-foreground hover:bg-primary/95 shadow-lg shadow-primary/20"
          >
            {isLoading ? (
              <>
  ...
  return (
    <motion.li
      ...
      className={cn(
        ...
        isDragTarget && 'bg-primary/[0.04] ring-1 ring-primary/40',
      )}
    >
...
function TypePill({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className={cn("min-w-[140px]", designTokens.layouts.glassCard.base)}>
...
function DeleteSceneButton({ onConfirm }: { onConfirm: () => void }) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent align="end" sideOffset={4} className={cn("w-56 p-3", designTokens.layouts.glassCard.base)}>
      ...
      >
        ...
        <span
          className={cn(
            ...
            // Edge: smaller, neutral, no shadow until hover; between: full primary badge
            isEdge
...
function QuizConfigDisclosure({
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button
          ...
          className={cn(
            ...
            'text-[var(--gyaan-teal-dark)] transition-colors hover:bg-[var(--gyaan-teal)]/[0.06] dark:text-purple-300',
          )}
        >
      ...
      <PopoverContent align="start" sideOffset={6} className={cn("w-64 space-y-2.5 p-3", designTokens.layouts.glassCard.base)}>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    'border',
                    selected
                      ? 'border-[var(--gyaan-teal)]/40 bg-[var(--gyaan-teal)]/10 text-purple-700 dark:text-purple-200'
