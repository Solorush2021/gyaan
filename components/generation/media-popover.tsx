...
export function MediaPopover({ onSettingsOpen }: MediaPopoverProps) {
  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <button
          className={cn(
            ...
            enabledCount > 0
              ? 'bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary-foreground border-primary/20 dark:border-primary/30 font-semibold shadow-sm'
      ...
      <PopoverContent align="start" side="bottom" avoidCollisions={false} className={cn("w-80 p-0", designTokens.layouts.glassCard.base)}>
