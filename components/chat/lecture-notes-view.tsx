  ...
  if (notes.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center p-6">
        <div className="w-12 h-12 bg-purple-50 dark:bg-purple-900/20 rounded-2xl flex items-center justify-center mb-3 text-purple-300 dark:text-[var(--gyaan-teal-dark)] ring-1 ring-purple-100 dark:ring-purple-800/30">
            ...
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <div
                className={cn(
                  ...
                  isCurrent
                    ? 'bg-[var(--gyaan-teal)] dark:bg-[var(--gyaan-teal-light)] shadow-sm shadow-[var(--gyaan-teal-light)]/40'
              ...
              <span
                className={cn(
                  ...
                  isCurrent
                    ? 'text-[var(--gyaan-teal-dark)] dark:text-[var(--gyaan-teal-light)]'
              ...
              {isCurrent && (
                <span className="text-[9px] font-bold px-1.5 py-px rounded-full bg-purple-100 dark:bg-purple-900/40 text-[var(--gyaan-teal-dark)] dark:text-purple-300">
