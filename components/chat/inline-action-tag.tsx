...
const WB_STYLE =
  'bg-[var(--gyaan-teal)]/8 dark:bg-[var(--gyaan-teal)]/15 border-[var(--gyaan-teal)]/50/40 dark:border-violet-500/30 text-[var(--gyaan-teal-dark)] dark:text-[var(--gyaan-teal-light)]';
const WB_ACCENT = 'bg-[var(--gyaan-teal)] dark:bg-[var(--gyaan-teal)]';
