      ...
      <div className="flex gap-1.5 items-center py-1.5 px-1">
        <span
          className={cn(
            ...
            isTeacher
              ? 'bg-[var(--gyaan-teal-light)]/70 dark:bg-[var(--gyaan-teal)]/70'
  ...
  return (
    <div
      className={cn(
        ...
        isUser
          ? 'bg-gradient-to-br from-[var(--gyaan-teal-dark)] to-purple-700 dark:from-[var(--gyaan-teal)] dark:to-[var(--gyaan-teal-dark)] text-white rounded-tr-sm shadow-sm shadow-purple-300/30 dark:shadow-purple-900/50 ring-1 ring-[var(--gyaan-teal)]/20'
          : isTeacher
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-[var(--gyaan-teal)] dark:border-l-[var(--gyaan-teal-light)] bg-[var(--gyaan-teal)]/8/50 dark:bg-violet-900/20',
              )}
            >
              {/* Mini Avatar */}
                ...
                <span
                  className={cn(
                    ...
                    isUser
                      ...
                      : isTeacher
                        ? 'text-[var(--gyaan-teal-light)] dark:text-purple-300'
