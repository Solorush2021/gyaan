...
export function AgentRevealModal({ agents, open, onClose, onAllRevealed }: AgentRevealModalProps) {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background/90 backdrop-blur-md transition-all duration-300"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background: `linear-gradient(160deg, ${agent.color}dd, ${lighten(agent.color, 0.2)}dd, ${agent.color}dd)`,
                        }}
                      >
                        {/* Inner card body */}
                        <div className={cn(
                          "relative flex size-full flex-col overflow-clip rounded-[15px]",
                          "bg-card/95 dark:bg-zinc-950/95 backdrop-blur-md shadow-premium dark:shadow-overlay border border-border/10"
                        )}>
                    ...
                    >
                      ...
                      <div
                        className="absolute inset-0 rounded-2xl p-[1px]"
                        style={{
                          background: 'linear-gradient(160deg, var(--primary), oklch(0.6 0.15 280), var(--primary))',
                        }}
                      >
                        <div
                          className={cn(
                            "relative flex size-full flex-col items-center justify-center rounded-[15px]",
                            "bg-card dark:bg-zinc-950 shadow-premium dark:shadow-overlay border border-border/10"
                          )}
                        >
