  ...
  return (
    ...
    >
      ...
      <PopoverContent
        ...
        sideOffset={4}
        className={cn(
          "w-80 p-0 sm:w-96 border border-border shadow-xl",
          "bg-card"
        )}
        onClick={(e) => e.stopPropagation()}
        onPointerDown={(e) => e.stopPropagation()}
        ...
        <div className="border-b border-border/40 p-2">
          <div className="relative">
            ...
            <input
              ...
              className="h-8 w-full rounded-md border border-input/60 bg-background/50 pl-8 pr-3 text-sm outline-none transition-colors placeholder:text-muted-foreground/40 focus:border-primary/50 focus:ring-2 focus:ring-primary/10"
            />
          </div>
        </div>
    ...
    <div className="flex items-center gap-1.5 shrink-0">
      ...
      {agentMode === 'auto' ? (
        <>
          ...
          <Shuffle className="size-4 text-violet-400 dark:text-[var(--gyaan-teal)]" />
        </>
      ) : (
        <>
    ...
    <div ref={containerRef} className="relative w-96">
        ...
        <TooltipTrigger asChild>
          <button
            className={cn(
              ...
              'border border-border text-muted-foreground/70 hover:text-foreground hover:bg-muted/40 shadow-sm bg-card',
              designTokens.layouts.subtleBorder
            )}
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div className={cn(
              "rounded-2xl px-2 py-1.5 shadow-xl border border-border bg-card",
              "bg-card/95 dark:bg-zinc-950/95"
            )}>
              {/* Teacher — always visible */}
              {teacherAgent && (
                <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-primary/[0.04] border border-primary/10 mb-2">
                  <div
                    className="size-7 rounded-full overflow-hidden shrink-0 ring-1 ring-border/40"
              ...
              {/* Mode tabs */}
              <div className="flex rounded-lg border border-border/50 bg-muted/20 p-0.5 mb-2">
                <button
                  onClick={() => handleModeChange('preset')}
                  className={cn(
                    'flex-1 py-1.5 text-xs font-medium rounded-md transition-all text-center cursor-pointer',
                    agentMode === 'preset'
                ...
                <button
                  ...
                  className={cn(
                    'flex-1 py-1.5 text-xs font-medium rounded-md transition-all text-center flex items-center justify-center gap-1 cursor-pointer',
                    agentMode === 'auto'
                      ? 'bg-background shadow-sm text-foreground border border-border/10'
                      : 'text-muted-foreground/80 hover:text-foreground',
                  )}
              ...
              {agentMode === 'preset' ? (
                ...
                <div className="flex flex-col items-center pt-6 pb-3 gap-4">
                  <div className="relative flex items-center justify-center">
                    <div className="absolute size-10 rounded-full bg-[var(--gyaan-teal)]/10 dark:bg-[var(--gyaan-teal)]/15 animate-ping [animation-duration:3s]" />
                    <div className="absolute size-12 rounded-full bg-[var(--gyaan-teal)]/5 dark:bg-[var(--gyaan-teal)]/10 animate-pulse [animation-duration:2.5s]" />
                    <Shuffle className="relative size-5 text-violet-400 dark:text-[var(--gyaan-teal)]" />
                  </div>
