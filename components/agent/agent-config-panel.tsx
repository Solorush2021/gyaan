  ...
  return (
    <div className="flex flex-col h-full p-4 gap-4 bg-background/50">
      <div className="flex items-center justify-between border-b border-border/40 pb-4">
        <div>
          <h2 className="text-lg font-semibold tracking-tight">智能体配置</h2>
          <p className="text-sm text-muted-foreground/80">管理课堂讨论的AI智能体</p>
        </div>
        <Button size="sm" variant="outline" className="border-border/60 hover:bg-muted/40">
            ...
            <Card
              ...
              className={cn(
                ...
                selectedAgent === agent.id 
                  ? 'border-primary ring-1 ring-primary/20 shadow-sm bg-primary/[0.01]' 
              ...
              <CardHeader className="p-4">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <Avatar
                      className="size-10 ring-1 ring-border/20 transition-all duration-200"
                      style={{
                        borderColor: agent.color,
                        borderWidth: 1.5,
                        boxShadow: `0 2px 8px 0 ${agent.color}15`,
                      }}
                    >
                    ...
                    <div>
                      <CardTitle className="text-base font-semibold tracking-tight">{agent.name}</CardTitle>
                      <CardDescription className="text-sm text-muted-foreground/70">{agent.role}</CardDescription>
                    </div>
                  </div>
