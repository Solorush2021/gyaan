...
const ctrlBtn = cn(
  ...
  'hover:bg-[var(--gyaan-teal)]/10 dark:hover:bg-[var(--gyaan-teal)]/10 active:scale-90',
);

/* Subtle separator */
function CtrlDivider() {
  return <div className="w-px h-3 bg-[var(--gyaan-teal)]/20 dark:bg-[var(--gyaan-teal)]/15 mx-0.5 shrink-0" />;
}
        ...
        <div
          className={cn(
            ...
            isPresenting
              ...
              : 'rounded-xl border border-border bg-card shadow-md px-1',
          )}
        >
          ...
          {onToggleMute && (
            ...
            >
              ...
              >
                  <div className="bg-popover border border-border rounded-lg shadow-md px-2 py-2.5 flex flex-col items-center gap-1.5">
                    ...
                    <input
                      ...
                      className={cn(
                        ...
                        '[&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[var(--gyaan-teal)] [&::-webkit-slider-thumb]:dark:bg-[var(--gyaan-teal-light)]',
                        '[&::-webkit-slider-thumb]:shadow-sm [&::-webkit-slider-thumb]:cursor-pointer',
                        '[&::-moz-range-thumb]:w-3 [&::-moz-range-thumb]:h-3',
                        '[&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-[var(--gyaan-teal)] [&::-moz-range-thumb]:border-0',
                      )}
                    />
                  </div>
                  {/* Arrow pointing down */}
                ...
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      ...
                      'active:scale-90',
                      playbackSpeed !== 1
                        ? 'text-[var(--gyaan-teal)] dark:text-[var(--gyaan-teal-light)] bg-[var(--gyaan-teal)]/10'
          ...
          >
            ...
            {!whiteboardOpen && whiteboardElementCount > 0 && (
              <span className="absolute top-0.5 right-0.5 w-1.5 h-1.5 bg-[var(--gyaan-teal)] dark:bg-[var(--gyaan-teal-light)] rounded-full" />
            )}
          </button>
        </div>
      </div>
