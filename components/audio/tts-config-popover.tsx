  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
          ...
          <PopoverTrigger asChild>
            <button
              className={cn(
                pillCls,
                ttsEnabled
                  ? 'bg-emerald-50/50 dark:bg-emerald-950/20 text-emerald-700 dark:text-emerald-300 border-emerald-500/20 dark:border-emerald-500/25 shadow-sm'
                  : 'text-muted-foreground/70 hover:text-foreground hover:bg-muted/40 border-border/10',
      ...
      <PopoverContent align="start" className={cn(
        "w-[280px] p-0 shadow-premium dark:shadow-overlay backdrop-blur-xl border border-border/40",
          ...
          <div className="px-3.5 py-3 space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                disabled={!canPreview}
                className={cn(
                  'inline-flex items-center gap-1 rounded-md px-2.5 py-1 text-[11px] font-medium transition-all shrink-0 border border-transparent cursor-pointer',
                  !canPreview && 'cursor-not-allowed opacity-40',
                  previewing
                    ? 'bg-emerald-100/80 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 border-emerald-500/20'
                    : 'bg-muted/50 text-muted-foreground/90 hover:bg-muted hover:text-foreground border-border/20',
                )}
              >
                {previewing ? (
