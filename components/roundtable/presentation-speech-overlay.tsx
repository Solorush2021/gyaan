    ...
    <div className="flex items-center gap-2" onClick={onExpand}>
      <div
        className={cn(
          ...
          bubble.role === 'user'
            ? 'bg-[var(--gyaan-teal)]/8/80 dark:bg-[var(--gyaan-slate-soft)] border-violet-200/70 dark:border-[var(--gyaan-teal)]/40/60'
            : bubble.role === 'agent'
      ...
      >
        <div
          className={cn(
            ...
            bubble.role === 'user'
              ? 'border-[var(--gyaan-teal)]/50 dark:border-[var(--gyaan-teal)]/60'
              : bubble.role === 'agent'
      ...
      {onPlayPause && (
        <div
          ...
          className={cn(
            ...
            'hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]',
            bubble.role === 'user'
              ? 'bg-[var(--gyaan-teal)]/8/80 dark:bg-[var(--gyaan-slate-soft)] border-violet-200/70 dark:border-[var(--gyaan-teal)]/40/60 hover:bg-violet-100 dark:hover:bg-violet-900/70'
              : bubble.role === 'agent'
  ...
  return (
    <div
      ...
      className={cn(
        ...
        bubble.role === 'user'
          ? 'bg-[var(--gyaan-teal)]/8/60 dark:bg-violet-950/55 border-violet-200/70 dark:border-[var(--gyaan-teal)]/40/60'
          : bubble.role === 'agent'
        ...
        <div className="min-w-0">
          <div
            className={cn(
              ...
              bubble.role === 'user'
                ? 'text-[var(--gyaan-teal)] dark:text-[var(--gyaan-teal-light)]'
                : bubble.role === 'agent'
                  ? 'text-blue-500 dark:text-blue-300'
                  : 'text-[var(--gyaan-teal)] dark:text-purple-300',
            )}
          >
            {bubble.role === 'user'
              ? t('roundtable.you')
            ...
            {[0, 0.2, 0.4].map((delay) => (
              <motion.div
                ...
                className={cn(
                  ...
                  bubble.role === 'user'
                    ? 'bg-[var(--gyaan-teal)] dark:bg-[var(--gyaan-teal)]'
                    : bubble.role === 'agent'
        ...
        (() => {
          ...
          if (buttonState === 'play') {
            return (
              ...
              >
                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 group-hover/bubble:text-[var(--gyaan-teal-dark)] dark:group-hover/bubble:text-[var(--gyaan-teal-light)] ml-0.5" />
              </div>
            );
          }
          ...
          if (buttonState === 'restart') {
            return (
              <div
                ...
                className="absolute right-2.5 bottom-2.5 z-20 p-1.5 rounded-full bg-white/40 dark:bg-gray-800/40 backdrop-blur-sm group-hover/bubble:bg-purple-100 dark:group-hover/bubble:bg-purple-900/50 transition-all duration-300 cursor-pointer"
              >
                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 group-hover/bubble:text-[var(--gyaan-teal-dark)] dark:group-hover/bubble:text-[var(--gyaan-teal-light)]" />
              </div>
            );
          }
