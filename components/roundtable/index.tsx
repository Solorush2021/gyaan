                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ...
                        : 'bg-[var(--gyaan-teal-dark)] hover:bg-purple-700 shadow-[0_4px_16px_rgba(147,51,234,0.3)]',
                    )}
                  >
                    {isSendCooldown ? (
              ...
              >
                <div className="flex items-center gap-4 bg-white/70 dark:bg-black/60 backdrop-blur-xl rounded-full px-5 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-gray-200/60 dark:border-white/10">
                  ...
                  <div className="flex items-center gap-0.5 h-8">
                    <VoiceWaveformBars barClassName="bg-gradient-to-t from-[var(--gyaan-teal-light)] to-[var(--gyaan-teal-light)]" />
                  </div>
                  <span className="text-[11px] font-semibold tracking-wider text-[var(--gyaan-teal-dark)] dark:text-purple-300 uppercase">
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-[var(--gyaan-teal-dark)] to-indigo-700 shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center group-hover:scale-105 transition-transform duration-300 border border-white/20">
                      <Mic className="w-5 h-5 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-[var(--gyaan-teal)] opacity-40 animate-[ping_2s_ease-in-out_infinite]" />
                  </button>
                </div>
              </motion.div>
            )}
                ...
                <div className="flex gap-1">
                  {[0, 0.2, 0.4].map((delay) => (
                    <motion.div
                      ...
                      className="w-1.5 h-1.5 rounded-full bg-[var(--gyaan-teal-light)]"
                    />
                  ))}
                </div>
                      ...
                      <div className="flex items-center gap-[3px]">
                        {[0, 1, 2].map((i) => (
                          <motion.div
                            ...
                            className="w-[3px] h-[3px] rounded-full bg-[var(--gyaan-teal-light)]"
                          />
                        ))}
                      </div>
                    </div>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          !asrEnabled
                            ...
                            : isVoiceOpen
                              ? 'bg-[var(--gyaan-teal-dark)] text-white'
                        ...
                        className={cn(
                          ...
                          isCueUser
                            ...
                            : activeRole === 'user' || isInputOpen
                              ? 'border-[var(--gyaan-teal)] shadow-[0_0_6px_rgba(168,85,247,0.3)]'
                              : 'border-gray-300/40 dark:border-white/20 group-hover:border-[var(--gyaan-teal-light)]/50',
                        )}
                      />
                      <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-800 overflow-hidden relative z-10 text-lg">
    ...
    <div
      className={cn(
        ...
        isPresenting && !controlsVisible
          ...
          : 'border-t border-emerald-900/50 bg-[#0d2a1d] text-emerald-100',
      )}
    >
      {/* Decorative SVG background */}
      {(!isPresenting || controlsVisible) && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 opacity-20">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 192" preserveAspectRatio="none">
            <path
              d="M-100,192 C300,100 500,250 800,80 C1100,-90 1300,120 1600,30 L1600,192 Z"
              fill="url(#green-grad)"
            />
            <path
              d="M-50,192 C400,50 600,180 900,120 C1200,60 1350,140 1550,90 L1550,192 Z"
              fill="url(#amber-grad)"
              opacity="0.6"
            />
            <defs>
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        <div
          className={cn(
            'w-[90px] shrink-0 flex flex-col border-r border-emerald-900/30 bg-emerald-950/20 overflow-visible relative transition-opacity duration-300 z-10',
            isPresenting && !controlsVisible && 'opacity-0 pointer-events-none',
          )}
        >
                ...
                <HoverCardTrigger asChild>
                  <div className="flex flex-col items-center gap-1">
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          activeRole === 'teacher'
                            ...
                            : 'border-emerald-800/60 group-hover:border-amber-500/50',
                        )}
                      />

                      <div className="w-10 h-10 rounded-full bg-emerald-950 overflow-hidden relative z-10 shadow-sm border border-emerald-800">
                        <img
                          src={teacherAvatar}
                          alt={teacherName}
                      ...
                      {activeRole === 'teacher' && (
                        <div className="absolute -right-0.5 top-0.5 w-4 h-4 bg-amber-500 rounded-full border border-emerald-950 flex items-center justify-center z-20">
                    ...
                    <span
                      className={cn(
                        'max-w-[80px] truncate px-2 py-0.5 rounded-full text-[10px] font-bold tracking-wider uppercase border shadow-sm transition-all duration-300 bg-emerald-950/80 border-emerald-800/50',
                        activeRole === 'teacher' && !speakingStudent
                          ? 'text-amber-400 border-amber-500/30'
                          : 'text-emerald-300/60 group-hover:text-amber-400 group-hover:border-amber-500/30',
                      )}
                    >
                      {teacherName}
                    </span>
        ...
        <div className="flex-1 relative mx-3 mb-2">
          ...
          <div
            ...
            className="relative w-full h-full rounded-[2.5rem] bg-gradient-to-b from-emerald-950/40 to-emerald-900/40 backdrop-blur-xl border border-emerald-800/30 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] flex flex-col justify-center px-6 overflow-hidden group transition-all duration-700 cursor-default z-10"
          >
            {/* Text input box */}
            <AnimatePresence>
              {isInputOpen && (
                ...
                >
                  <div className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-emerald-950/95 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-emerald-800 flex items-end gap-2 ring-1 ring-emerald-900/50">
                    <div className="pl-4 flex-1 py-1 min-w-0">
                      <textarea
                        ...
                        autoFocus
                        rows={1}
                        className="w-full resize-none bg-transparent border-none focus:ring-0 focus:outline-none outline-none shadow-none ring-0 text-emerald-100 text-sm placeholder:text-emerald-500/50 min-h-[40px] max-h-[120px]"
                        style={{ fieldSizing: 'content' } as Record<string, string>}
                      />
                    </div>
                    <button
                      ...
                      disabled={isSendCooldown}
                      className={cn(
                        'p-2.5 text-emerald-950 rounded-xl transition shadow-md mb-0.5 shrink-0 font-semibold',
                        isSendCooldown
                          ? 'bg-emerald-800/50 cursor-not-allowed shadow-none text-emerald-600'
                          : 'bg-amber-500 hover:bg-amber-600 shadow-amber-955/50',
                      )}
                    >
                      {isSendCooldown ? (
              ...
              {isVoiceOpen && (
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-emerald-900/80 backdrop-blur-md rounded-xl border border-emerald-700/50 shadow-sm">
                      <VoiceWaveformBars barClassName="bg-gradient-to-t from-emerald-400 to-amber-500" />
                    </div>
                    <motion.div
                      initial={{ opacity: 0, x: 10 }}
                      animate={{ opacity: 1, x: 0 }}
                      className="text-[10px] font-bold tracking-widest text-amber-400 uppercase bg-emerald-950/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm border border-emerald-800/50 mr-1"
                    >
                      {isProcessing ? t('roundtable.processing') : t('roundtable.listening')}
                    </motion.div>
                  </div>
                  ...
                  <div
                    ...
                    onClick={handleToggleVoice}
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 shadow-[0_4px_20px_rgba(245,158,11,0.4)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-300 border border-white/20">
                      <Mic className="w-6 h-6 text-emerald-950" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-amber-400 opacity-40 animate-[ping_2s_ease-in-out_infinite] z-10" />
                    ...
                    <div className="absolute inset-0 bg-amber-500 blur-2xl opacity-20 group-hover:opacity-40 transition-opacity z-0" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <AnimatePresence>
              {thinkingState?.stage === 'director' && !currentSpeech && !userMessage && (
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  exit={{ opacity: 0, scale: 0.9 }}
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex items-center gap-2 px-4 py-2 bg-emerald-950/90 backdrop-blur-md rounded-full shadow-sm border border-emerald-800/50"
                >
                  <div className="flex gap-1">
                    <motion.div
                      animate={{ opacity: [0.3, 1, 0.3] }}
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-emerald-400 to-emerald-600 shadow-emerald-400/30 hover:shadow-emerald-400/40',
                      )}
                    >
                      {asrEnabled ? (
                    ...
                    <div className="flex items-center justify-center gap-[3px] h-3">
                      {[0, 1, 2, 3, 2, 1, 0].map((intensity, i) => (
                        <motion.div
                          ...
                          className="w-[2.5px] h-full origin-center rounded-full bg-emerald-400/60"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        bubbleRole === 'user'
                          ? 'bg-amber-600 text-white rounded-br-sm shadow-md border border-amber-500 shadow-amber-900/30'
                          : bubbleRole === 'agent'
                            ? cn(
                                'bg-emerald-900/95 backdrop-blur-sm border-emerald-800 text-emerald-100 rounded-br-sm shadow-sm',
                                (isInLiveFlow || isTopicPending) &&
                                  'hover:shadow-md cursor-pointer',
                              )
                            : 'bg-emerald-950/95 border-emerald-800 text-emerald-100 rounded-bl-sm shadow-sm hover:shadow-md cursor-pointer',
                      )}
                    >
                      {bubbleRole &&
                        (() => {
                            ...
                            <motion.div
                              ...
                              className={cn(
                                ...
                                isAgentLoading
                                  ...
                                  : 'bg-[var(--gyaan-teal-light)] dark:bg-[var(--gyaan-teal)]',
                              )}
                            />
                            <motion.div
                              animate={{ opacity: [0.3, 1, 0.3] }}
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          const barsColor =
                            bubbleRole === 'agent' ? 'bg-blue-500' : 'bg-[var(--gyaan-teal)]';
                          ...
                          if (btnState === 'play') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-purple-100 dark:hover:bg-purple-900/50 group-hover/bubble:bg-purple-100 dark:group-hover/bubble:bg-purple-900/50 transition-all duration-300 cursor-pointer">
                                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-[var(--gyaan-teal-dark)] dark:hover:text-[var(--gyaan-teal-light)] group-hover/bubble:text-[var(--gyaan-teal-dark)] dark:group-hover/bubble:text-[var(--gyaan-teal-light)] ml-0.5" />
                              </div>
                            );
                          }
                          ...
                          if (btnState === 'restart') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-purple-100 dark:hover:bg-purple-900/50 group-hover/bubble:bg-purple-100 dark:group-hover/bubble:bg-purple-900/50 transition-all duration-300 cursor-pointer">
                                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-[var(--gyaan-teal-dark)] dark:hover:text-[var(--gyaan-teal-light)] group-hover/bubble:text-[var(--gyaan-teal-dark)] dark:group-hover/bubble:text-[var(--gyaan-teal-light)]" />
                              </div>
                            );
                          }
                          ...
                          return (
                            <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 group-hover/bubble:bg-purple-100 dark:group-hover/bubble:bg-purple-900/50 transition-all duration-300">
                              {isDiscussionPaused ? (
                                ...
                                <Play className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400 group-hover/bubble:text-[var(--gyaan-teal-dark)] dark:group-hover/bubble:text-[var(--gyaan-teal-light)] ml-0.5" />
                              ) : (
                                <>
                                  ...
                                  {/* Pause icon on hover */}
                                  <Pause className="w-3.5 h-3.5 text-[var(--gyaan-teal-dark)] dark:text-[var(--gyaan-teal-light)] hidden group-hover/bubble:block" />
                                </>
                              )}
                            </div>
                          );
        ...
        <div
          className={cn(
            'w-[140px] shrink-0 flex flex-col py-3 border-l border-emerald-900/30 bg-emerald-950/20 overflow-visible relative transition-opacity duration-300 z-10',
            isPresenting && !controlsVisible && 'opacity-0 pointer-events-none',
          )}
        >
          ...
          <div className="flex-none relative group/scroll">
            ...
            <button
              ...
              className="absolute left-0 top-0 bottom-0 w-5 z-10 flex items-center justify-center bg-gradient-to-r from-emerald-950/90 to-transparent opacity-0 group-hover/scroll:opacity-100 transition-opacity cursor-pointer"
            >
                      ...
                      <HoverCard openDelay={300} closeDelay={100}>
                        <HoverCardTrigger asChild>
                          ...
                          >
                            ...
                            />
                            <div className="absolute inset-0.5 rounded-full bg-emerald-950 overflow-hidden">
                              <img
                                src={student.avatar}
                                alt={student.name}
                            ...
                            {/* Speaking indicator */}
                            {isSpeaking && (
                              <div className="absolute -right-0.5 -top-0.5 w-3 h-3 bg-amber-500 rounded-full border border-emerald-950 z-20 flex items-center justify-center">
                                <div className="w-1 h-1 bg-white rounded-full animate-pulse" />
                              </div>
                            )}
          ...
          {/* Divider */}
          <div className="mx-auto my-1.5 w-8 h-px bg-emerald-800 opacity-50 shrink-0" />
                ...
                <>
                  <button
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ? 'bg-emerald-950/40 text-emerald-800 border-emerald-900/30 cursor-not-allowed'
                        : isVoiceOpen
                          ? 'bg-amber-500 border-amber-500 text-emerald-950 shadow-amber-900/50 font-bold'
                          : 'bg-emerald-900/80 border-emerald-800 text-emerald-300 hover:bg-emerald-850 hover:text-amber-400 hover:border-amber-500/30',
                    )}
                  >
                    {asrEnabled ? (
                  ...
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ...
                        : 'border-emerald-800 group-hover:border-amber-500/50',
                  )}
                />
                <div className="w-14 h-14 rounded-full bg-emerald-950 overflow-hidden relative z-10 shadow-sm border border-emerald-800 text-2xl">
                  <AvatarDisplay src={userAvatar} alt={t('roundtable.you')} />
                </div>
                <div className="absolute top-0 right-0 w-5 h-5 bg-emerald-950 rounded-full flex items-center justify-center shadow-md border border-emerald-800 z-20">
                  <div
                    className={cn(
                      'w-1.5 h-1.5 rounded-full',
                      isInputOpen || isCueUser
                        ? 'bg-[var(--gyaan-teal)] animate-pulse'
