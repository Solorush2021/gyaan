  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 p-6 opacity-[0.03]">
        <PieChart className="w-52 h-52 text-[var(--gyaan-teal)]" />
      </div>
      <div className="absolute bottom-0 left-0 p-6 opacity-[0.02]">
        <BookOpenText className="w-40 h-40 text-[var(--gyaan-teal)] rotate-12" />
      </div>
      ...
      <motion.div
        ...
        className="w-16 h-16 bg-gradient-to-br from-[var(--gyaan-teal)]/10 to-[var(--gyaan-teal)]/5 50 dark:from-violet-900/50 dark:to-purple-900/30 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-100 dark:shadow-violet-900/30 ring-1 ring-violet-200/50 dark:ring-violet-700/50"
      >
        <PieChart className="w-8 h-8 text-[var(--gyaan-teal)]" />
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
          <div className="w-7 h-7 rounded-lg bg-[var(--gyaan-teal)]/8 dark:bg-[var(--gyaan-teal)]/12 flex items-center justify-center">
            <BookOpenText className="w-3.5 h-3.5 text-[var(--gyaan-teal)]" />
          </div>
          <span>
        ...
        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
          <div className="w-7 h-7 rounded-lg bg-[var(--gyaan-teal)]/8 dark:bg-[var(--gyaan-teal)]/12 flex items-center justify-center">
            <PieChart className="w-3.5 h-3.5 text-[var(--gyaan-teal)]" />
          </div>
          <span>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="mt-1 px-8 py-2.5 bg-gradient-to-r from-[var(--gyaan-teal)] to-[var(--gyaan-teal-dark)] text-white rounded-full font-medium shadow-lg shadow-violet-200/50 dark:shadow-violet-900/50 hover:shadow-violet-300/50 transition-shadow z-10 flex items-center gap-2"
      >
        {t('quiz.startQuiz')}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isReview &&
                  !selected &&
                  'border-gray-200 dark:border-gray-600 hover:border-violet-200 dark:hover:border-violet-700 hover:bg-[var(--gyaan-teal)]/8/50 dark:hover:bg-violet-900/30',
                !isReview &&
                  selected &&
                  'border-[var(--gyaan-teal)] bg-[var(--gyaan-teal)]/8 dark:bg-[var(--gyaan-teal)]/12 ring-1 ring-violet-200 dark:ring-violet-700',
                // Review states
                isReview &&
                  isCorrectOpt &&
            ...
            >
              <span
                className={cn(
                  ...
                  !isReview && selected && 'bg-[var(--gyaan-teal)] text-white',
              ...
              <span
                className={cn(
                  ...
                  !isReview &&
                    !isSelected &&
                    'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400',
                  !isReview && isSelected && 'bg-[var(--gyaan-teal)] text-white',
                  isReview && isCorrectOpt && 'bg-emerald-500 text-white',
      ...
      {!isReview ? (
        <div className="relative">
          <textarea
            ...
            className="w-full min-h-[100px] p-3 pb-10 rounded-xl border border-gray-200 dark:border-gray-600 text-sm resize-none focus:outline-none focus:border-[var(--gyaan-teal)]/50 dark:focus:border-violet-600 focus:ring-2 focus:ring-violet-100 dark:focus:ring-violet-900/50 transition-all disabled:bg-gray-50 dark:disabled:bg-gray-800 disabled:text-gray-500 dark:bg-gray-800/50 dark:text-gray-200 dark:placeholder:text-gray-500"
          />
          <SpeechButton
            size="sm"
            disabled={disabled}
        ...
        <div className="space-y-3">
          ...
          {result.aiComment && (
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-[var(--gyaan-teal)]/8 dark:bg-[var(--gyaan-teal)]/12 border border-violet-100 dark:border-[var(--gyaan-teal)]/40">
              <Sparkles className="w-4 h-4 text-[var(--gyaan-teal)] shrink-0 mt-0.5" />
              <div>
                <p className="text-xs font-medium text-[var(--gyaan-teal-dark)] dark:text-[var(--gyaan-teal-light)] mb-0.5">
                  {t('quiz.aiComment')}
                </p>
                <p className="text-xs text-[var(--gyaan-teal-dark)]/80 dark:text-[var(--gyaan-teal-light)]/80">
                  {result.aiComment}
                </p>
              </div>
              <span className="ml-auto text-xs font-bold text-[var(--gyaan-teal-dark)] dark:text-[var(--gyaan-teal-light)] shrink-0">
        ...
        <div className="flex items-start gap-3">
          <span
            className={cn(
              ...
              !isReview &&
                'bg-violet-100 dark:bg-[var(--gyaan-teal)]/15 text-[var(--gyaan-teal-dark)] dark:text-[var(--gyaan-teal-light)]',
              isReview &&
                result.status === 'correct' &&
      ...
      <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              <div className="flex items-center gap-2">
                <PieChart className="w-4 h-4 text-[var(--gyaan-teal)]" />
              ...
              <button
                ...
                className={cn(
                  ...
                  allAnswered
                    ? 'bg-gradient-to-r from-[var(--gyaan-teal)] to-[var(--gyaan-teal-dark)] text-white shadow-sm hover:shadow-md hover:shadow-violet-200/50 dark:hover:shadow-violet-900/50 active:scale-[0.97]'
        ...
        {phase === 'grading' && (
          ...
          >
            ...
            >
              <Loader2 className="w-10 h-10 text-[var(--gyaan-teal)]" />
            </motion.div>
            ...
            <div className="flex gap-1 mt-2">
              {[0, 1, 2].map((i) => (
                <motion.div
                  key={i}
                  className="w-2 h-2 rounded-full bg-[var(--gyaan-teal)]"
        ...
        {phase === 'reviewing' && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              ...
              <button
                onClick={handleRetry}
                className="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 hover:text-[var(--gyaan-teal-dark)] dark:hover:text-violet-400 transition-colors"
              >
