    ...
    <div className="flex w-max items-center gap-1">
      ...
      >
        <SelectTrigger
          ...
          className="w-32 border-0 px-2 text-xs font-normal text-muted-foreground shadow-none hover:bg-accent hover:text-foreground"
        >
      ...
      <div className="flex h-8 items-center rounded-md bg-secondary p-0.5">
        ...
        <input
          ...
          className="w-9 bg-transparent text-center text-xs font-semibold tabular-nums text-foreground outline-none focus:bg-card"
        />
        <BarButton
