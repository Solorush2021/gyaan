    ...
    >
      <div
        ...
        className={cn(
          ...
          active
            ? 'bg-primary/5 ring-1 ring-primary/30 dark:bg-primary/10 dark:ring-primary/40'
            : 'hover:bg-accent/40',
        )}
      >
          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            {renaming ? (
              <input
                ...
                className={cn(
                  'min-w-0 flex-1 truncate rounded-sm bg-card px-1 py-0 text-xs font-bold outline-none',
                  'ring-1 ring-primary/50 focus:ring-primary',
                  'text-foreground',
                )}
              />
            ) : (
