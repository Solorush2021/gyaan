...
export function SlideNavRail() {
  ...
  const themeVars = designTokens.cssVariables[resolvedTheme];
    ...
    >
      ...
      {!collapsed && (
        <div
          ...
          className="group absolute right-0 top-0 bottom-0 w-1.5 cursor-col-resize touch-none hover:bg-primary/20 active:bg-primary/30 transition-colors"
        >
      ...
      {/* Header band — mirrors playback `SceneSidebar`: Gyaan logo
      ...
      >
        {!collapsed && (
          <button
            ...
            className="flex items-center gap-2 cursor-pointer rounded-lg px-1.5 -mx-1.5 py-1 -my-1 hover:bg-accent/80 active:scale-[0.97] transition-all duration-150"
          >
        ...
        <div className={cn('flex items-center gap-1', collapsed && 'flex-col')}>
          ...
          <button
            ...
            className={cn(
              ...
              'bg-secondary/80 text-muted-foreground ring-1 ring-border/20',
