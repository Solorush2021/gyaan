...
export function UserProfileCard() {
  ...
  if (!hydrated) {
    return (
      <Card className="p-5 !gap-0 rounded-xl border border-border bg-card shadow-md">
  ...
  return (
    <Card className="p-5 !gap-0 rounded-xl border border-border bg-card shadow-md">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-muted overflow-hidden ring-2 ring-[var(--gyaan-teal)]/40 dark:ring-[var(--gyaan-teal)]/35 group-hover/avatar:ring-[var(--gyaan-teal)] dark:group-hover/avatar:ring-[var(--gyaan-teal-light)] transition-all">
          ...
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="flex-1 min-w-0 h-7 bg-transparent border-b-2 border-[var(--gyaan-teal)] dark:border-[var(--gyaan-teal-light)] text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-[var(--gyaan-teal)] hover:bg-[var(--gyaan-teal)]/10 dark:hover:bg-[var(--gyaan-teal)]/15 transition-colors"
              >
              ...
              {AVATAR_OPTIONS.map((url) => (
                <button
                  ...
                  className={cn(
                    ...
                    avatar === url
                      ? 'ring-2 ring-[var(--gyaan-teal)] dark:ring-[var(--gyaan-teal-light)] ring-offset-1 ring-offset-background'
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-[var(--gyaan-teal)] dark:ring-[var(--gyaan-teal-light)] ring-offset-1 ring-offset-background border-[var(--gyaan-teal)]/50 dark:border-[var(--gyaan-teal)]/40 bg-[var(--gyaan-teal)]/5 dark:bg-[var(--gyaan-teal)]/10'
