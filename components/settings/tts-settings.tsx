...
function VoiceProfileRow({
  ...
  const iconClassName =
    kind === 'auto'
      ? 'bg-[var(--gyaan-teal)]/8 text-[var(--gyaan-teal-dark)] dark:bg-[var(--gyaan-teal)]/10 dark:text-[var(--gyaan-teal-light)]'
      : kind === 'clone'
        ? 'bg-sky-50 text-sky-700 dark:bg-sky-950/40 dark:text-sky-300'
        : 'bg-muted text-muted-foreground';
  const badgeClassName =
    badgeTone === 'default'
      ? 'border-violet-200 bg-[var(--gyaan-teal)]/8 text-[var(--gyaan-teal-dark)] dark:border-[var(--gyaan-teal)]/40/70 dark:bg-[var(--gyaan-teal)]/10 dark:text-[var(--gyaan-teal-light)]'
      : badgeTone === 'warning'
