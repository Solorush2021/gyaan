    ...
    <div className="w-60 h-40 mx-auto flex items-center justify-center">
      <div className="flex gap-3">
        {[0, 1, 2].map((i) => (
          <motion.div
            key={i}
            className="w-14 h-20 rounded-lg bg-gradient-to-br from-[var(--gyaan-teal-light)] to-blue-500 dark:from-[var(--gyaan-teal-dark)] dark:to-blue-700 shadow-lg"
    ...
    switch (idx) {
      ...
      case 1:
        return {
          ...
          label: 'QUIZ',
          badge:
            'bg-purple-100 text-[var(--gyaan-teal-dark)] border-purple-200 dark:bg-purple-900/40 dark:text-purple-300 dark:border-purple-800',
        };
      case 2:
        return {
          color: 'amber',
    ...
    <div className="size-56 relative flex items-center justify-center perspective-[800px]">
      ...
      <motion.div
        ...
        className={cn(
          ...
          theme.color === 'purple' && 'bg-[var(--gyaan-teal)]/10',
      ...
      {[0, 1].map((i) => (
        <motion.div
          ...
          className={cn(
            ...
            theme.color === 'purple' && 'border-[var(--gyaan-teal)]/10',
          ...
          >
            ...
            {index === 1 && (
              <div className="flex flex-col h-full justify-center space-y-2 pt-2">
                ...
                >
                  <div className="h-2 w-3/4 bg-[var(--gyaan-teal)]/20 rounded-full" />
                </motion.div>
                  ...
                  {[0, 1, 2, 3].map((i) => (
                    <motion.div
                      ...
                      className={cn(
                        ...
                        i === 1
                          ? 'bg-[var(--gyaan-teal)] text-white border-[var(--gyaan-teal)]'
...
function ActionsVisualizer() {
  ...
  const actionItems = [
    {
      icon: MessageSquare,
      label: 'Speech',
      color: 'text-[var(--gyaan-teal)]',
      activeBg: 'bg-[var(--gyaan-teal)]/10',
      activeBorder: 'border-violet-200 dark:border-[var(--gyaan-teal)]/40',
    },
    {
      icon: Focus,
      label: 'Spotlight',
  ...
  return (
    <div className="size-56 relative flex items-center justify-center">
      {/* Background pulse */}
      <motion.div
        className="absolute inset-0 blur-3xl rounded-full bg-[var(--gyaan-teal)]/8"
        animate={{ scale: [1, 1.15, 1], opacity: [0.3, 0.5, 0.3] }}
        transition={{ duration: 3.5, repeat: Infinity }}
      />
      ...
      <div className="w-44 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden relative">
        {/* Header */}
        <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-700 flex items-center gap-2">
          <Clapperboard className="size-3 text-[var(--gyaan-teal)]" />
          <motion.div
            initial={{ width: 0 }}
            animate={{ width: '50%' }}
            transition={{ delay: 0.2 }}
            className="h-1.5 bg-[var(--gyaan-teal)]/20 rounded-full"
          />
        </div>
        ...
        <div className="p-2 space-y-1.5 relative">
          ...
          <motion.div
            className="absolute left-2 right-2 rounded-lg bg-[var(--gyaan-teal)]/[0.06] dark:bg-[var(--gyaan-teal)]/[0.08]"
            style={{ height: ROW_H - 6 }}
          ...
          {actionItems.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <motion.div
                  className="size-1.5 rounded-full bg-[var(--gyaan-teal)]"
