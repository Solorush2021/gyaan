...
function HomePage() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-background flex flex-col items-center px-4 pt-16 pb-12 md:px-8 md:pt-20 overflow-x-hidden">
      <input
        ref={fileInputRef}
        type="file"
        accept=".zip"
      ...
      <div
        ref={toolbarRef}
        className="fixed top-4 right-4 z-50 flex items-center gap-1 bg-card px-2 py-1.5 rounded-full border border-border shadow-sm"
      >
        {/* Language Selector */}
        ...
        <div className="relative">
          ...
          {themeOpen && (
            <div className="absolute top-full mt-2 right-0 bg-card border border-border rounded-lg shadow-lg overflow-hidden z-50 min-w-[140px]">
              <button
                onClick={() => {
                  setTheme('light');
                  setThemeOpen(false);
                ...
                className={cn(
                  'w-full px-4 py-2 text-left text-sm hover:bg-muted/60 transition-colors flex items-center gap-2',
                  theme === 'light' &&
      ...
      <motion.div
        ...
        className={cn(
          'relative z-20 w-full max-w-3xl mx-auto flex flex-col items-center px-4',
          classrooms.length === 0 ? 'justify-center min-h-[calc(100dvh-8rem)] py-16' : 'py-16 md:py-24',
        )}
      >
        {/* ── Logo ── */}
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-bold tracking-tight mb-3 text-foreground"
        >
          Gyaan
        </motion.h1>
        ...
        <motion.div
          ...
          className="w-full"
        >
          <div className="w-full rounded-2xl border border-border bg-card shadow-sm transition-shadow focus-within:shadow-md">
            ...
            {/* Textarea — large, readable, inviting */}
            <textarea
              ref={textareaRef}
              placeholder={t('upload.requirementPlaceholder')}
              className="w-full resize-none border-0 bg-transparent px-5 pt-3 pb-3 text-base leading-relaxed placeholder:text-muted-foreground/40 focus:outline-none min-h-[160px] max-h-[340px]"
            ...
            <div className="px-3 pb-3 flex items-end gap-2">
              ...
              {/* Send button — big, friendly, clearly tappable */}
              <button
                onClick={handleGenerate}
                disabled={!canGenerate}
                className={cn(
                  'shrink-0 h-11 rounded-xl flex items-center justify-center gap-2 transition-all px-5',
                  canGenerate
                    ? 'bg-primary text-primary-foreground hover:opacity-90 shadow-md hover:shadow-lg cursor-pointer active:scale-[0.98]'
      ...
      {!open && (
        ...
        >
          <div className="shrink-0 relative">
            <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-border/30 group-hover:ring-[var(--gyaan-teal)]/60 dark:group-hover:ring-[var(--gyaan-teal)]/40 transition-all duration-300">
          ...
          >
            <div className="rounded-2xl bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm ring-1 ring-black/[0.04] dark:ring-white/[0.06] shadow-[0_1px_8px_-2px_rgba(0,0,0,0.06)] dark:shadow-[0_1px_8px_-2px_rgba(0,0,0,0.3)] px-2.5 py-2">
              ...
              >
                ...
                >
                  <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-violet-300/70 dark:ring-[var(--gyaan-teal)]/40 transition-all duration-300">
                    <img src={avatar} alt="" className="size-full object-cover" />
                  </div>
                  <motion.div
                    initial={{ scale: 0 }}
                ...
                <div className="flex-1 min-w-0">
                  {editingName ? (
                    <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                      ...
                      <button
                        onClick={commitName}
                        className="shrink-0 size-5 rounded flex items-center justify-center text-[var(--gyaan-teal)] hover:bg-violet-100 dark:hover:bg-violet-900/30"
                      >
                        ...
                        {AVATAR_OPTIONS.map((url) => (
                          <button
                            ...
                            className={cn(
                              ...
                              avatar === url
                                ? 'ring-2 ring-[var(--gyaan-teal)] dark:ring-[var(--gyaan-teal)] ring-offset-0'
                        ...
                        <label
                          className={cn(
                            ...
                            isCustomAvatar(avatar)
                              ? 'ring-2 ring-[var(--gyaan-teal)] dark:ring-[var(--gyaan-teal)] ring-offset-0 border-[var(--gyaan-teal)]/50 dark:border-[var(--gyaan-teal)]/60 bg-[var(--gyaan-teal)]/8 dark:bg-[var(--gyaan-teal)]/12'
  ...
  return (
    <div className="group cursor-pointer" onClick={confirmingDelete ? undefined : onClick}>
      ...
      <div className="mt-2.5 px-1 flex items-center gap-2">
        <span className="shrink-0 inline-flex items-center rounded-full bg-violet-100 dark:bg-[var(--gyaan-teal)]/12 px-2 py-0.5 text-[11px] font-medium text-[var(--gyaan-teal-dark)] dark:text-[var(--gyaan-teal-light)]">
        ...
        {editing ? (
          <div className="flex-1 min-w-0" onClick={(e) => e.stopPropagation()}>
            <input
              ...
              className="w-full bg-transparent border-b border-[var(--gyaan-teal)]/60 text-[15px] font-medium text-foreground/90 outline-none placeholder:text-muted-foreground/40"
            />
          </div>
        ) : (
          <Tooltip>
