...
Establish which Gyaan checkout will be used for setup and runtime actions.

## Procedure

1. Check whether Gyaan already exists locally.
...
```bash
git clone https://github.com/THU-GYAAN/Gyaan.git
cd Gyaan
```
